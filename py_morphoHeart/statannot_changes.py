...
def add_stat_annotation(ax, plot='boxplot',
                        ...
                        fontsize='medium', verbose=1, fontname='Myriad Pro'):
    """
    ...
    for box_struct1, box_struct2 in box_struct_pairs:
        ...
        if y_stack_arr[2, i_ymax_in_range_x1_x2] == 0:
            ...
            offset = y_offset
        if text is not None and text != 'ns': # Modified
            y = yref2 + offset
        else: 
            y = yref2     # Modified
        ...
        elif text is not None:# and text == 'ns': # Modified
            y_top_annot = y + h
